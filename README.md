...
**Guarda de contexto — obrigatória.** Todo comando que fala com cluster verifica antes
que o contexto ativo é `k3d-dop-local` e recusa executar se não for. Esta máquina tem
contextos de produção de clientes no kubeconfig.
